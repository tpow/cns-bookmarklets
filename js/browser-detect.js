...
function getBrowser(a){
	...
	var n=t(a),i={},e={};
	n.browser && (i[n.browser]=!0, i.version=n.version, i.ios=n.ios, i.android=n.android), i.chrome ? i.webkit=!0 : i.webkit && (i.safari=!0), i.edg ? i.edge=!0 && (delete i.edg) : null, "73"<i.version && i.edge ? (i.chrome=!0) : null, i.trident ? !(i.edge) && (i.msie=!0) : null, i.android ? i.safari=!1 : null, e.browser=i;
	return e;
}
